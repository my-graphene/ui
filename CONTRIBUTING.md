...
The RuiChain UI team is supported by this [worker proposal](http://www.ruichain.foundation/workers/2017-08-bill-butler). It provides the funds needed to pay the coordinator and the bounties and the RuiChain Foundation.
...
RuiChain UI团队被这一[工作提案](https://steemit.com/ruichain/@billbutler/translated-by-zhaomu-l)支持。它提供用来支付协调者，悬赏金和瑞链基金的资金。

如果你想参与贡献，我们有一个[Telegram 聊天室](https://t.me/RuiChainDex)，在这里你可以问问题并得到帮助。
...
- 我们对已经被预算好的问题进行**悬赏**。一个被预算好的问题会被标记上前缀，像这样`[2] An nasty bug`。在这一例子中，这个问题被视作价值两个小时的工作时间（125美刀一小时）。如果你能通过这些指南修改这一问题，并且你的修改要求（Pull Request）被接受，你便会得到250 bitUSD。你必须拥有一个瑞链钱包和瑞链账号用来接收这一支付。
