...
const MSG_HEAD = "-----BEGIN RUICHAIN SIGNED MESSAGE-----";
const MSG_META = "-----BEGIN META-----";
const MSG_SIGNATURE = "-----BEGIN SIGNATURE-----";
const MSG_FOOT = "-----END RUICHAIN SIGNED MESSAGE-----";
...
class SignedMessageAction {
     ...
     *                      block : Current last irreversible block of the ruichain blockchain
